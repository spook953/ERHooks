...
namespace er::event_flags
{
	...
	static event_flag_map_t boss_defeated_map{};
	...
	const event_flag_map_t &GetBossDefeatedMap() { return boss_defeated_map; }
}
...
// https://docs.google.com/spreadsheets/d/1kI4WqLq-XU7ZrBvImHp_HtFM4m4oD5WVj3ub4H5fqS8/edit?gid=1629311778#gid=1629311778
static auto er_event_flags_init_boss_defeated_map = [&]() -> bool
{
	er::event_flags::boss_defeated_map[10000800] = "Godrick the Grafted";
	er::event_flags::boss_defeated_map[10000850] = "Margit, the Fell Omen";
	er::event_flags::boss_defeated_map[10010800] = "Grafted Scion";
	er::event_flags::boss_defeated_map[11000800] = "Morgott, the Omen King";
	er::event_flags::boss_defeated_map[11000850] = "Godfrey (Golden Shade)";
	er::event_flags::boss_defeated_map[11050800] = "Godfrey / Hoarah Loux";
	er::event_flags::boss_defeated_map[11050800] = "Sir Gideon Ofnir, the All-Knowing";
	er::event_flags::boss_defeated_map[12010800] = "Dragonkin Soldier of Nokstella";
	er::event_flags::boss_defeated_map[12010850] = "Dragonkin Soldier (Lake of Rot)";
	er::event_flags::boss_defeated_map[12020800] = "Valiant Gargoyles";
	er::event_flags::boss_defeated_map[12020830] = "Dragonkin Soldier (Siofra)";
	er::event_flags::boss_defeated_map[12020850] = "Mimic Tear";
	er::event_flags::boss_defeated_map[12030390] = "Crucible Knight Siluria";
	er::event_flags::boss_defeated_map[12030800] = "Fia's Champions";
	er::event_flags::boss_defeated_map[12030850] = "Lichdragon Fortissax";
	er::event_flags::boss_defeated_map[12040800] = "Astel, Naturalborn of the Void";
	er::event_flags::boss_defeated_map[12050800] = "Mohg, Lord of Blood";
	er::event_flags::boss_defeated_map[12080800] = "Ancestor Spirit";
	er::event_flags::boss_defeated_map[12090800] = "Regal Ancestor Spirit";
	er::event_flags::boss_defeated_map[13000800] = "Beast Clergyman / Maliketh";
	er::event_flags::boss_defeated_map[13000830] = "Dragonlord Placidusax";
	er::event_flags::boss_defeated_map[13000850] = "Godskin Duo";
	er::event_flags::boss_defeated_map[14000800] = "Rennala, Queen of the Full Moon";
	er::event_flags::boss_defeated_map[14000850] = "Red Wolf of Radagon";
	er::event_flags::boss_defeated_map[15000800] = "Malenia, Blade of Miquella";
	er::event_flags::boss_defeated_map[15000850] = "Loretta, Knight of the Haligtree";
	er::event_flags::boss_defeated_map[16000800] = "Rykard, Lord of Blasphemy";
	er::event_flags::boss_defeated_map[16000850] = "Godskin Noble (Volcano Manor)";
	er::event_flags::boss_defeated_map[16000860] = "Abductor Virgins";
	er::event_flags::boss_defeated_map[18000800] = "Ulcerated Tree Spirit (Limgrave)";
	er::event_flags::boss_defeated_map[18000850] = "Soldier of Godrick";
	er::event_flags::boss_defeated_map[19000800] = "Elden Beast";
	er::event_flags::boss_defeated_map[19000800] = "Radagon / Elden Beast";
	er::event_flags::boss_defeated_map[19000800] = "Radagon of the Golden Order";
	er::event_flags::boss_defeated_map[20000800] = "Divine Beast Dancing Lion";
	er::event_flags::boss_defeated_map[20010800] = "Promised Consort Radahn";
	er::event_flags::boss_defeated_map[21000850] = "Golden Hippopotamus";
	er::event_flags::boss_defeated_map[21010800] = "Messmer the Impaler";
	er::event_flags::boss_defeated_map[22000800] = "Putrescent Knight";
	er::event_flags::boss_defeated_map[25000800] = "Metyr, Mother of Fingers";
	er::event_flags::boss_defeated_map[28000800] = "Midra, Lord of Frenzied Flame";
	er::event_flags::boss_defeated_map[30000800] = "Cemetery Shade (Weeping Peninsula)";
	er::event_flags::boss_defeated_map[30010800] = "Erdtree Burial Watchdog (Weeping Peninsula)";
	er::event_flags::boss_defeated_map[30020800] = "Erdtree Burial Watchdog (Limgrave)";
	er::event_flags::boss_defeated_map[30030800] = "Spiritcaller Snail (Liurnia)";
	er::event_flags::boss_defeated_map[30040800] = "Grave Warden Duelist (Limgrave)";
	er::event_flags::boss_defeated_map[30050800] = "Cemetery Shade (Liurnia)";
	er::event_flags::boss_defeated_map[30050850] = "Black Knife Assassin (Liurnia)";
	er::event_flags::boss_defeated_map[30060800] = "Erdtree Burial Watchdog (Liurnia)";
	er::event_flags::boss_defeated_map[30070800] = "Erdtree Burial Watchdog (Altus)";
	er::event_flags::boss_defeated_map[30080800] = "Ancient Hero of Zamor (Altus)";
	er::event_flags::boss_defeated_map[30090800] = "Red Wolf of the Champion";
	er::event_flags::boss_defeated_map[30100800] = "Crucible Knight Ordovis";
	er::event_flags::boss_defeated_map[30110800] = "Black Knife Assassin (Limgrave)";
	er::event_flags::boss_defeated_map[30120800] = "Perfumer Tricia + Misbegotten Warrior";
	er::event_flags::boss_defeated_map[30130800] = "Grave Warden Duelist (Capital Outskirts)";
	er::event_flags::boss_defeated_map[30140800] = "Erdtree Burial Watchdog x2";
	er::event_flags::boss_defeated_map[30150800] = "Cemetery Shade (Caelid)";
	er::event_flags::boss_defeated_map[30160800] = "Putrid Tree Spirit (Caelid)";
	er::event_flags::boss_defeated_map[30170800] = "Ancient Hero of Zamor (Mountaintops)";
	er::event_flags::boss_defeated_map[30180800] = "Ulcerated Tree Spirit (Mountaintops)";
	er::event_flags::boss_defeated_map[30190800] = "Putrid Grave Warden Duelist";
	er::event_flags::boss_defeated_map[30200800] = "Stray Mimic Tear";
	er::event_flags::boss_defeated_map[31000800] = "Patches";
	er::event_flags::boss_defeated_map[31010800] = "Runebear";
	er::event_flags::boss_defeated_map[31020800] = "Miranda the Blighted Bloom";
	er::event_flags::boss_defeated_map[31030800] = "Beastman of Farum Azula (Limgrave)";
	er::event_flags::boss_defeated_map[31040800] = "Cleanrot Knight";
	er::event_flags::boss_defeated_map[31050800] = "Bloodhound Knight (Liurnia)";
	er::event_flags::boss_defeated_map[31060800] = "Crystalian x2 (Liurnia)";
	er::event_flags::boss_defeated_map[31070800] = "Kindred of Rot x2";
	er::event_flags::boss_defeated_map[31090800] = "Demi-Human Queen Margot";
	er::event_flags::boss_defeated_map[31100800] = "Beastman of Farum Azula x2";
	er::event_flags::boss_defeated_map[31110800] = "Putrid Crystalian x3";
	er::event_flags::boss_defeated_map[31120800] = "Misbegotten Crusader";
	er::event_flags::boss_defeated_map[31150800] = "Demi-Human Chief x2";
	er::event_flags::boss_defeated_map[31170800] = "Guardian Golem";
	er::event_flags::boss_defeated_map[31180800] = "Omenkiller + Miranda";
	er::event_flags::boss_defeated_map[31190800] = "Black Knife Assassin (Invisible)";
	er::event_flags::boss_defeated_map[31190850] = "Necromancer Garris";
	er::event_flags::boss_defeated_map[31200800] = "Cleanrot Knight x2";
	er::event_flags::boss_defeated_map[31210800] = "Frenzied Duelist";
	er::event_flags::boss_defeated_map[31220800] = "Spiritcaller Snail (Mountaintops)";
	er::event_flags::boss_defeated_map[32000800] = "Scaly Misbegotten";
	er::event_flags::boss_defeated_map[32010800] = "Stonedigger Troll (Limgrave)";
	er::event_flags::boss_defeated_map[32020800] = "Crystalian (Liurnia)";
	er::event_flags::boss_defeated_map[32040800] = "Stonedigger Troll (Altus)";
	er::event_flags::boss_defeated_map[32050800] = "Crystalian x2 (Altus)";
	er::event_flags::boss_defeated_map[32070800] = "Magma Wyrm (Caelid)";
	er::event_flags::boss_defeated_map[32080800] = "Fallingstar Beast (Caelid)";
	er::event_flags::boss_defeated_map[32110800] = "Astel, Stars of Darkness";
	er::event_flags::boss_defeated_map[34120800] = "Onyx Lord (Capital Outskirts)";
	er::event_flags::boss_defeated_map[34130800] = "Godskin Apostle (Caelid)";
	er::event_flags::boss_defeated_map[34140850] = "Fell Twins";
	er::event_flags::boss_defeated_map[35000800] = "Mohg, the Omen";
	er::event_flags::boss_defeated_map[35000850] = "Esgar, Priest of Blood";
	er::event_flags::boss_defeated_map[39200800] = "Magma Wyrm Makar";
	er::event_flags::boss_defeated_map[40000800] = "Death Knight (Gravesite Plain)";
	er::event_flags::boss_defeated_map[40010800] = "Death Knight (Rauh Base)";
	er::event_flags::boss_defeated_map[41000800] = "Demi-Human Swordmaster Onze";
	er::event_flags::boss_defeated_map[41010800] = "Curseblade Labirith";
	er::event_flags::boss_defeated_map[41020800] = "Lamenter";
	er::event_flags::boss_defeated_map[43000800] = "Chief Bloodfiend";
	er::event_flags::boss_defeated_map[43010800] = "Ancient Dragon-Man";
	er::event_flags::boss_defeated_map[1033420800] = "Alecto, Black Knife Ringleader";
	er::event_flags::boss_defeated_map[1033430800] = "Erdtree Avatar (Liurnia West)";
	er::event_flags::boss_defeated_map[1033450800] = "Bols, Carian Knight";
	er::event_flags::boss_defeated_map[1034420800] = "Glintstone Dragon Adula";
	er::event_flags::boss_defeated_map[1034450800] = "Glintstone Dragon Smarag";
	er::event_flags::boss_defeated_map[1034480800] = "Royal Revenant";
	er::event_flags::boss_defeated_map[1035420800] = "Omenkiller (Liurnia)";
	er::event_flags::boss_defeated_map[1035500800] = "Royal Knight Loretta";
	er::event_flags::boss_defeated_map[1035530800] = "Magma Wyrm (Mt. Gelmir)";
	er::event_flags::boss_defeated_map[1036450800] = "Death Rite Bird (Liurnia)";
	er::event_flags::boss_defeated_map[1036480800] = "Night's Cavalry (Liurnia North)";
	er::event_flags::boss_defeated_map[1036500800] = "Onyx Lord (Liurnia)";
	er::event_flags::boss_defeated_map[1036540800] = "Full-Grown Fallingstar Beast";
	er::event_flags::boss_defeated_map[1037420800] = "Deathbird (Liurnia)";
	er::event_flags::boss_defeated_map[1037460800] = "Bell Bearing Hunter (Liurnia)";
	er::event_flags::boss_defeated_map[1037530800] = "Demi-Human Queen Maggie";
	er::event_flags::boss_defeated_map[1037540810] = "Ulcerated Tree Spirit (Mt. Gelmir)";
	er::event_flags::boss_defeated_map[1038410800] = "Adan, Thief of Fire";
	er::event_flags::boss_defeated_map[1038480800] = "Erdtree Avatar (Liurnia East)";
	er::event_flags::boss_defeated_map[1038510800] = "Demi-Human Queen Gilika";
	er::event_flags::boss_defeated_map[1038520800] = "Tibia Mariner (Altus)";
	er::event_flags::boss_defeated_map[1039430800] = "Night's Cavalry (Liurnia East)";
	er::event_flags::boss_defeated_map[1039440800] = "Tibia Mariner (Liurnia)";
	er::event_flags::boss_defeated_map[1039500800] = "Godefroy the Grafted";
	er::event_flags::boss_defeated_map[1039510800] = "Night's Cavalry (Altus)";
	er::event_flags::boss_defeated_map[1039540800] = "Elemer of the Briar";
	er::event_flags::boss_defeated_map[1040520800] = "Black Knife Assassin (Altus)";
	er::event_flags::boss_defeated_map[1040530800] = "Sanguine Noble";
	er::event_flags::boss_defeated_map[1041500800] = "Fallingstar Beast (Altus)";
	er::event_flags::boss_defeated_map[1041510800] = "Tree Sentinel x2 (Altus)";
	er::event_flags::boss_defeated_map[1041520800] = "Ancient Dragon Lansseax";
	er::event_flags::boss_defeated_map[1041530800] = "Giant Wormface";
	er::event_flags::boss_defeated_map[1042330800] = "Ancient Hero of Zamor (Weeping Peninsula)";
	er::event_flags::boss_defeated_map[1042360800] = "Tree Sentinel (Limgrave)";
	er::event_flags::boss_defeated_map[1042370800] = "Crucible Knight";
	er::event_flags::boss_defeated_map[1042380800] = "Deathbird (Limgrave)";
	er::event_flags::boss_defeated_map[1042380850] = "Bell Bearing Hunter (Limgrave)";
	er::event_flags::boss_defeated_map[1042550800] = "Godskin Apostle (Altus)";
	er::event_flags::boss_defeated_map[1043300800] = "Leonine Misbegotten";
	er::event_flags::boss_defeated_map[1043330800] = "Erdtree Avatar (Weeping Peninsula)";
	er::event_flags::boss_defeated_map[1043360800] = "Flying Dragon Agheel";
	er::event_flags::boss_defeated_map[1043370800] = "Night's Cavalry (Limgrave)";
	er::event_flags::boss_defeated_map[1043530800] = "Bell Bearing Hunter (Capital Outskirts)";
	er::event_flags::boss_defeated_map[1044320800] = "Deathbird (Weeping Peninsula)";
	er::event_flags::boss_defeated_map[1044320850] = "Night's Cavalry (Weeping Peninsula)";
	er::event_flags::boss_defeated_map[1044350800] = "Bloodhound Knight Darriwil";
	er::event_flags::boss_defeated_map[1044360800] = "Mad Pumpkin Head";
	er::event_flags::boss_defeated_map[1044530800] = "Deathbird (Capital Outskirts)";
	er::event_flags::boss_defeated_map[1045390800] = "Tibia Mariner (Limgrave)";
	er::event_flags::boss_defeated_map[1045520800] = "Draconic Tree Sentinel";
	er::event_flags::boss_defeated_map[1047400800] = "Putrid Avatar (Caelid)";
	er::event_flags::boss_defeated_map[1048370800] = "Decaying Ekzykes";
	er::event_flags::boss_defeated_map[1048400800] = "Mad Pumpkin Head x2";
	er::event_flags::boss_defeated_map[1048410800] = "Bell Bearing Hunter (Dragonbarrow)";
	er::event_flags::boss_defeated_map[1048510800] = "Night's Cavalry (Forbidden Lands)";
	er::event_flags::boss_defeated_map[1048570800] = "Death Rite Bird (Snowfield)";
	er::event_flags::boss_defeated_map[1049370800] = "Night's Cavalry (Caelid)";
	er::event_flags::boss_defeated_map[1049370850] = "Death Rite Bird (Caelid)";
	er::event_flags::boss_defeated_map[1049380800] = "Commander O'Neil";
	er::event_flags::boss_defeated_map[1049390800] = "Nox Swordstress & Nox Monk";
	er::event_flags::boss_defeated_map[1049390850] = "Battlemage Hugues";
	er::event_flags::boss_defeated_map[1049520800] = "Black Blade Kindred (Forbidden Lands)";
	er::event_flags::boss_defeated_map[1050560800] = "Great Wyrm Theodorix";
	er::event_flags::boss_defeated_map[1050570800] = "Death Rite Bird (Mountaintops)";
	er::event_flags::boss_defeated_map[1050570850] = "Putrid Avatar (Snowfield)";
	er::event_flags::boss_defeated_map[1051360800] = "Misbegotten Warrior + Crucible Knight";
	er::event_flags::boss_defeated_map[1051400800] = "Putrid Avatar (Dragonbarrow)";
	er::event_flags::boss_defeated_map[1051430800] = "Black Blade Kindred (Dragonbarrow)";
	er::event_flags::boss_defeated_map[1051570800] = "Commander Niall";
	er::event_flags::boss_defeated_map[1052410800] = "Flying Dragon Greyll";
	er::event_flags::boss_defeated_map[1052410850] = "Night's Cavalry (Dragonbarrow)";
	er::event_flags::boss_defeated_map[1052560800] = "Erdtree Avatar (Mountaintops)";
	er::event_flags::boss_defeated_map[1053560800] = "Roundtable Knight Vyke";
	er::event_flags::boss_defeated_map[1248550800] = "Night's Cavalry x2";
	er::event_flags::boss_defeated_map[1252380800] = "Starscourge Radahn";
	er::event_flags::boss_defeated_map[1252520800] = "Fire Giant";
	er::event_flags::boss_defeated_map[1254560800] = "Borealis, the Freezing Fog";
	er::event_flags::boss_defeated_map[2044450800] = "Romina, Saint of the Bud";
	er::event_flags::boss_defeated_map[2044470800] = "Rugalea the Great Red Bear";
	er::event_flags::boss_defeated_map[2045440800] = "Ghostflame Dragon (Gravesite Plain)";
	er::event_flags::boss_defeated_map[2045470200] = "Crucible Knight Devonia";
	er::event_flags::boss_defeated_map[2046380800] = "Dancer of Ranah";
	er::event_flags::boss_defeated_map[2046400800] = "Demi-Human Queen Marigga";
	er::event_flags::boss_defeated_map[2046410800] = "Knight of the Solitary Gaol";
	er::event_flags::boss_defeated_map[2046450800] = "Red Bear";
	er::event_flags::boss_defeated_map[2046460800] = "Divine Beast Dancing Lion (Rauh)";
	er::event_flags::boss_defeated_map[2047390800] = "Death Rite Bird (Charo's Hidden Grave)";
	er::event_flags::boss_defeated_map[2047450800] = "Black Knight Garrew";
	er::event_flags::boss_defeated_map[2048380850] = "Ghostflame Dragon (Cerulean Coast)";
	er::event_flags::boss_defeated_map[2048440800] = "Rellana, Twin Moon Knight";
	er::event_flags::boss_defeated_map[2049410800] = "Jagged Peak Drake";
	er::event_flags::boss_defeated_map[2049430800] = "Ghostflame Dragon (Scadu Altus)";
	er::event_flags::boss_defeated_map[2049430850] = "Black Knight Edredd";
	er::event_flags::boss_defeated_map[2049440800] = "Dryleaf Dane";
	er::event_flags::boss_defeated_map[2049450800] = "Ralva the Great Red Bear";
	er::event_flags::boss_defeated_map[2049480800] = "Commander Gaius";
	er::event_flags::boss_defeated_map[2050470800] = "Tree Sentinel x2 (Hinterland)";
	er::event_flags::boss_defeated_map[2050480800] = "Scadutree Avatar";
	er::event_flags::boss_defeated_map[2051440800] = "Rakshasa";
	er::event_flags::boss_defeated_map[2051450800] = "Count Ymir, Mother of Fingers";
	er::event_flags::boss_defeated_map[2052400800] = "Jagged Peak Drake x2";
	er::event_flags::boss_defeated_map[2052430800] = "Jori, Elder Inquisitor";
	er::event_flags::boss_defeated_map[2052480800] = "Fallingstar Beast (Hinterland)";
	er::event_flags::boss_defeated_map[2054390800] = "Bayle the Dread";
	er::event_flags::boss_defeated_map[2054390850] = "Ancient Dragon Senessax";
