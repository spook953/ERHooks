...
static auto er_event_flags_init_boss_defeated_map = [&]() -> bool
{
	...
	er::event_flags::boss_defeated_map[11050850] = "Sir Gideon Ofnir, the All-Knowing";
	...
	er::event_flags::boss_defeated_map[2050470800] = "Tree Sentinel 1st (Hinterland)";
	er::event_flags::boss_defeated_map[2050480860] = "Tree Sentinel 2nd (Hinterland)";
